...
CREATE TABLE IF NOT EXISTS appointments (
    ...
    status          ENUM('requested', 'scheduled', 'confirmed', 'rescheduled', 'completed', 'cancelled', 'no_show') NOT NULL DEFAULT 'scheduled',
...
CREATE TABLE IF NOT EXISTS company_settings (
    ...
    tax_vat_number  VARCHAR(100) DEFAULT NULL,
    invoice_payable_name VARCHAR(255) DEFAULT NULL,
    bank_account_number VARCHAR(64) DEFAULT NULL,
    bank_sort_code  VARCHAR(32) DEFAULT NULL,
    bank_iban       VARCHAR(64) DEFAULT NULL,
    bank_bic        VARCHAR(32) DEFAULT NULL,
    bank_account_1  TEXT DEFAULT NULL,
    bank_account_2  TEXT DEFAULT NULL,
    bank_account_3  TEXT DEFAULT NULL,
    invoice_bank_account TINYINT UNSIGNED NOT NULL DEFAULT 1,
    default_invoice_payment_terms VARCHAR(255) DEFAULT NULL,
