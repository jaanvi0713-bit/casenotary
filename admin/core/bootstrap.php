...
require_once __DIR__ . '/ChatbotScope.php';
require_once __DIR__ . '/ChatbotDraft.php';
require_once __DIR__ . '/ChatbotCaseContext.php';
require_once __DIR__ . '/ChatbotActions.php';
require_once __DIR__ . '/ChatbotReports.php';
require_once __DIR__ . '/ChatbotDocumentText.php';
require_once __DIR__ . '/ChatbotDocuments.php';
require_once __DIR__ . '/ChatbotInsights.php';
require_once __DIR__ . '/ChatbotCompanyKnowledge.php';
require_once __DIR__ . '/ClientChatbotService.php';
